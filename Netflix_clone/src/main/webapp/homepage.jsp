...
<script>
    ...
    function fetchSuggestions() {
        ...
        fetch("AutoSuggestServlet?query=" + query)
            ...
            .then(data => {
                ...
                data.forEach(movie => {
                    ...
                    div.onclick = function () {
                        document.getElementById("search-box").value = movie;
                        suggestionBox.innerHTML = "";
                    };
...
<div class="navbar">
    ...
    <% } else { %>
		...
		<div class="search-container">
		    <input type="text" id="search-box" placeholder="Search movies..." oninput="fetchSuggestions()">
